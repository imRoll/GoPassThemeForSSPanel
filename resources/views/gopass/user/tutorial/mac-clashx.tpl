                                ...
                                <div class="card-body">
                                    <div class="media"><img class="img-50 img-fluid m-r-20"
                                        ...
                                        <div class="media-body">
                                            <h6 class="f-w-600 font-primary">在 Mac 上使用
                                                ClashX</h6>
                                    ...
                                    <p class="mt-2">ClashX 是一个拥有 GUI 界面基于 Clash 可自定义规则的 macOS 代理应用。
                                    支持 Shadowsocks 协议和其 simple-obfs 插件、v2ray-plugin 插件以及 VMess 协议和其 TCP、WebSocket 等传输方式。</p>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-3 col-md-4 col-6">
                                                <img class="img-thumbnail"
                                                    data-original="/theme/gopass/images/app/clash-1.png"
                                                    src="/theme/gopass/images/app/clashx-1.png">
                                            </div>
                                            <div class="col-xl-9 col-md-8 col-6">
                                                <h5>配置 ClashX for Mac - 1</h5>
                                                <p>打开 ClashX，此时会提示您需要安装一个小工具，点击 安装 随后输入 macOS 账户密码即可。</p>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-xl-3 col-md-4 col-6">
                                                <img class="img-thumbnail"
                                                    data-original="/theme/gopass/images/app/clash-2.png"
                                                    src="/theme/gopass/images/app/clashx-2.png">
                                            </div>
                                            <div class="col-xl-9 col-md-8 col-6">
                                                <h5>配置 ClashX for Mac -2</h5>
                                                <p>点击菜单栏中 ClashX 的图标，选择 配置 => 托管配置 => 设置地址，粘贴上方 获取订阅 中的订阅链接。</p>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-xl-3 col-md-4 col-6">
                                                <img class="img-thumbnail"
                                                    data-original="/theme/gopass/images/app/clash-3.png"
                                                    src="/theme/gopass/images/app/clashx-3.png">
                                            </div>
                                            <div class="col-xl-9 col-md-8 col-6">
                                                <h5>配置 ClashX for Mac -3</h5>
                                                <p>点击菜单栏中 ClashX 的图标，出站模式选择 规则，勾选下方的 设为系统代理 以及 开机启动。</p>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-xl-3 col-md-4 col-6">
                                                <img class="img-thumbnail"
                                                    data-original="/theme/gopass/images/app/clash-4.png"
                                                    src="/theme/gopass/images/app/clashx-4.png">
                                            </div>
                                            <div class="col-xl-9 col-md-8 col-6">
                                            <h5 class="mt-3 f-w-600">开始使用</h5>
                                            <p>点击菜单栏中 ClashX 的图标，然后在下方的 Proxy 策略组 中选择 AUTO 或者你中意的节点即可。
                                            </p>
                                            </div>
                                        </div>
                                    </div>
