<div class="card-inner">
    ...
    <div class="form-group form-group-label">
        ...
        <input class="form-control" id="bitpayx-amount" type="text" placeholder="输入充值金额后，点击你要付款的应用图标即可">
    </div>
</div>
<div id="bitpayx-qrarea">
    <button class="btn btn-flat waves-attach" id="bitpayx-alipay-submit" name="type" onclick="bitpay('ALIPAY')"><img
    ...
    <button class="btn btn-flat waves-attach" id="bitpayx-wechat-submit" name="type" onclick="bitpay('WECHAT')"><img
                ...
                width="64" height="64"></button>
    <button class="btn btn-flat waves-attach" id="bitpayx-crypto-submit" name="type" onclick="bitpay('CRYPTO')"><img
