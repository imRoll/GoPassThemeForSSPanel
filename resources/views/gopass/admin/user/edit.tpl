                ...
                <div class="card">
                    <div class="card-main">
                        <div class="card-inner">
                            ...
                            <div class="form-group form-group-label">
                                <label class="floating-label" for="ref_money">返利余额</label>
                                <input class="form-control maxwidth-edit" id="ref_money" type="text"
                                       value="{$edit_user->ref_money}">
                            </div>
