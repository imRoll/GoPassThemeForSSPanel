                    ...
                    <div class="card">
                        <div class="card-main">
                            <div class="card-inner">
                                ...
                                <div class="form-group form-group-label">
                                    <label class="floating-label" for="sort2">节点排序</label>
                                    <input class="form-control maxwidth-edit" id="sort2" type="text" name="sort2" value="{$node->sort2}">
                                </div>
