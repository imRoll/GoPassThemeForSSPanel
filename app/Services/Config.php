...
class Config
{
    ...
    public static function getPublicConfig()
    {
        return [
            ...
            'quantit_money' => self::get('quantit_money'),
            'quantit_class' => self::get('quantit_class'),
            'quantit_connector' => self::get('quantit_connector'),
            'quantit_speedlimit' => self::get('quantit_speedlimit')
        ];
    }
