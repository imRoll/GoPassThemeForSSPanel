...
class HomeController extends BaseController
{
    ...
    public function index($request, $response, $args): ResponseInterface
    {
        ...
        $shops = GoPassConfig::get("shops_class");
        $shop_one = Shop::where('id',$shops['class_1'])->first();
        $shop_two = Shop::where('id',$shops['class_2'])->first();
        $shop_three = Shop::where('id',$shops['class_3'])->first();
        ...
        if (Config::get('newIndex') === false && Config::get('theme') == 'material') {
            ...
            return $response->write($this->view()
	            ...
	            ->assign('shop_one',$shop_one)
	            ->assign('shop_two',$shop_two)
	            ->assign('shop_three',$shop_three)
