...
class AdminController extends UserController
{
    ...
    public function DelCoupon($request, $response, $args)
    {
    ...
    public function ajax_coupon($request, $response, $args)
    {
		...
		$datatables->edit('op', static function ($data) {
            return '<a class="btn btn-brand-accent" id="delete" href="javascript:void(0);" onClick="delete_modal_show(\'' . $data['id'] . '\')">删除</a>';
        });
