...
$GoPass_Config['google_analytics_code'] = 'UA-190941528-1';    // Google 统计代码，留空为不开启，code格式为 'UA-123456789-1'
...
$GoPass_Config['lastest_update'] = [    // 这里可以继续添加或删除数组来更改您的信息
    '1' => [
        array(
            'title' => '',    //标题
            'content' => '<a href="/user/shop"><img src="https://www.gopass.cc/theme/gopass/index/images/gopass_600x400.png"></a>',    //内容
        )
    ],
    '2' => [
        array(
