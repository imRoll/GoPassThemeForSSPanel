...
(function(factory) {
    ...
    $.fn.TouchSpin = function(options) {
        ...
        var defaults = {
            min: 50, // If null, there is no minimum enforced
            max: 300, // If null, there is no maximum enforced
            initval: '',
            replacementval: '',
            step: 1,
            decimals: 0,
        ...
        return this.each(function() {
            ...
            function _advanceInputGroup(parentelement) {
                ...
                if (prev.hasClass('input-group-btn') || prev.hasClass('input-group-prepend')) {
                    downhtml = '<button class="' + settings.buttondown_class + ' bootstrap-touchspin-down  count_price bootstrap-touchspin-injected" type="button">' + settings.buttondown_txt + '</button>';
                ...
                if (next.hasClass('input-group-btn') || next.hasClass('input-group-append')) {
                    uphtml = '<button class="' + settings.buttonup_class + ' bootstrap-touchspin-up bootstrap-touchspin-injected  count_price" type="button">' + settings.buttonup_txt + '</button>';
                    next.prepend(uphtml);
                } else {
