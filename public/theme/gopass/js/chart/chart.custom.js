...
var barData = {
    ...
    datasets: [{
        ...
        strokeColor: GopassAdminConfig.primary,
        highlightFill: "rgba(145, 46, 252, 0.6)",
        highlightStroke: GopassAdminConfig.primary,
        data: [35, 59, 80, 81, 56, 55, 40]
    }, {
        label: "My Second dataset",
        fillColor: "rgba(247, 49, 100, 0.4)",
        strokeColor: GopassAdminConfig.secondary,
        highlightFill: "rgba(247, 49, 100, 0.6)",
        highlightStroke: GopassAdminConfig.secondary,
...
var polarData = [{
    ...
    value: 120,
    color: GopassAdminConfig.secondary,
    highlight: GopassAdminConfig.secondary,
    label: "Dark Grey"
}];
var polarOptions = {
...
var lineGraphData = {
    ...
    datasets: [{
        ...
        strokeColor: GopassAdminConfig.primary,
        pointColor: GopassAdminConfig.primary,
        ...
        strokeColor: GopassAdminConfig.secondary,
        pointColor: GopassAdminConfig.secondary,
        pointStrokeColor: "#fff",
        pointHighlightFill: "#000",
        pointHighlightStroke: GopassAdminConfig.secondary,
        data: [28, 48, 40, 19, 86, 27, 90]
    }]
};
...
var radarData = {
    ...
    datasets: [{
        ...
        strokeColor: GopassAdminConfig.primary,
        pointColor: GopassAdminConfig.primary,
        pointStrokeColor: GopassAdminConfig.primary,
        pointHighlightFill: GopassAdminConfig.primary,
